...
function printHTML() {
    ...
    bookInfo.forEach((book, i) => {
        const readButtonText = book.checkBox ? "Not Read" : "Read"; // Toggle button text
        content.insertAdjacentHTML('beforeend', `
            <div class="flex flex-col items-center justify-center">
                <div class="flex flex-col items-center justify-center bg-white space-y-4 mt-4 rounded-lg">
                    ...
                    <div class="px-6"><button class="bg-${book.checkBox ? 'red-400' : 'green-300'} w-22rem text-2xl font-medium rounded-md py-4" onclick="isRead(${i})">${readButtonText}</button></div>
